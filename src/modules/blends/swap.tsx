import { PlusCircleIcon, SwitchHorizontalIcon } from '@heroicons/react/solid';
...
const SwapBlend = () => {
  ...
  return (
    <DashLayout title="Swap Blend">
      <BlendContainer title="Swap Blend" info="Swap a NFT asset to a different one.">
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="text-center">
              ...
              <div className="mt-6">
                <button
                  type="button"
                  className="border-2 border-sage rounded-xl h-80 w-64 flex items-center justify-center"
                >
